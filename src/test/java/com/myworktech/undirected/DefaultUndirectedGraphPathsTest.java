...
public class DefaultUndirectedGraphPathsTest {
    ...
    @Test
    public void checkGraphIsUndirected() {
        DefaultUndirectedGraph<Object> graph = new DefaultUndirectedGraph<>();
        Object vertex1 = new Object();
        Object vertex2 = new Object();
        graph.addVertex(vertex1);
        ...
        Set<DefaultPath<Object>> actualPaths = graph.getPath(vertex2, vertex1);
        Assert.assertEquals(expectedPaths, actualPaths);
    }
    ...
    public void getPath4() throws Throwable {
        DefaultUndirectedGraph<String> graph = new DefaultUndirectedGraph<>();
        String vertex1 = "1";
        String vertex2 = "2";
        String vertex3 = "3";
        String vertex4 = "4";
